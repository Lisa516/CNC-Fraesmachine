...
public class FileReader {
	...
	public static JsonObject readIn() throws FileNotFoundException {
		Gson gson = new Gson();
	...
	public static JsonObject readIn(String file) throws FileNotFoundException {
		Gson gson = new Gson();
        // Datei "Befehlscode.json" über einen Stream einlesen
        FileInputStream input = new FileInputStream("src/application/Settings.json");
        BufferedReader reader = new BufferedReader(new InputStreamReader(input));
	...
	public static JsonArray createJSArray() throws FileNotFoundException {
		JsonArray commands = readIn().getAsJsonArray("commands");
		return commands;
	}
	
	public static JsonArray createJSArray(String file) throws FileNotFoundException {
		JsonArray commands = readIn("settings.json").getAsJsonArray();
		return commands;
	}
	
public static String[] contentAsStringArray() throws FileNotFoundException {
		
		JsonArray commands = createJSArray();
	...
	public static String[] putCommandsInOrder() throws FileNotFoundException {
		String[] commandsOrigin = contentAsStringArray();
